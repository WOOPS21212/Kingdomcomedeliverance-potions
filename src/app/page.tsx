      ...
      >
        ...
        >
          ...
          <div style={{ 
            ...
            {/* Placeholder text for mapgenie image */}
            <p style={{ color: '#aaa', position: 'absolute', zIndex: 1 }}>MapGenie Map Image</p>
            
            {/* Image will be added once file is available */}
            {/* <Image 
              src="/images/mapgenie.jpg" 
        ...
        >
          ...
          <div style={{
            ...
            <Image 
              src="/potion-recipes/KCD2-Savious-Schnapps.jpg" 
